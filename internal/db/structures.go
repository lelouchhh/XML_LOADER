...
type AddHouseTypes struct{
	...
	Request			string			`default:"INSERT INTO api_gar.gar_addhouse_types 
										(id, name, shortname, _desc, updatedate, startdate, enddate, isactive)
...
type Object struct{
	...
	ID				int				`xml:"ID,attr" db:"id"`
	ObjectID		string			`xml:"OBJECTID,attr" db:"objectid"`
	...
	Level			string			`xml:"LEVEL,attr" db:"level"`
	OperTypeID		string			`xml:"OPERTYPEID,attr" db:"opertypeid"`
	prevID			string			`xml:"PREVID,attr" db:"previd"`
	nextID			string			`xml:"NEXTID,attr" db:"nextid"`
	UpdateDate		string			`xml:"UPDATEDATE,attr" db:"updatedate"`
	StartDate		string			`xml:"STARTDATE,attr" db:"startdate"`
	EndDate			string			`xml:"ENDDATE,attr" db:"enddate"`
...
type ObjectLevel struct{
	...
	Level			int				`xml:"ID,attr" db:"level"`
	Name			string			`xml:"NAME,attr" db:"name"`
	StartDate		string			`xml:"STARTDATE,attr" db:"startdate"`
	EndDate			string			`xml:"ENDDATE,attr" db:"enddate"`
	UpdateDate		string			`xml:"UPDATEDATE,attr" db:"updatedate"`
